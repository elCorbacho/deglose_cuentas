...
describe('group', () => {
  ...
  it('preserves category totals after removing merchant grouping', () => {
    const txs = [
      { fecha: '01 Mar', comercio: 'JUMBO', monto: 30000, ciudad: 'SANTIAGO', raw: 'a', categoria: 'Supermercado' },
      { fecha: '05 Mar', comercio: 'JUMBO', monto: 25000, ciudad: 'SANTIAGO', raw: 'b', categoria: 'Supermercado' },
      { fecha: '10 Mar', comercio: 'UNIMARC', monto: 40000, ciudad: 'SANTIAGO', raw: 'c', categoria: 'Supermercado' },
    ]
  ...
  it('sorts transactions by date descending within each category', () => {
    const txs = [
      { fecha: '01 Mar', comercio: 'JUMBO', monto: 30000, ciudad: 'SANTIAGO', raw: 'a', categoria: 'Supermercado' },
      { fecha: '15 Mar', comercio: 'UNIMARC', monto: 25000, ciudad: 'SANTIAGO', raw: 'b', categoria: 'Supermercado' },
      { fecha: '10 Mar', comercio: 'LIDER', monto: 40000, ciudad: 'SANTIAGO', raw: 'c', categoria: 'Supermercado' },
    ]
    const result = group(txs)
  ...
  it('sorts DD/MM/YY dates by descending chronology across year boundaries', () => {
    const txs = [
      { fecha: '31/12/23', comercio: 'TIENDA A', monto: 1000, ciudad: 'SANTIAGO', raw: 'a', categoria: 'Otros' },
      { fecha: '01/01/24', comercio: 'TIENDA B', monto: 2000, ciudad: 'SANTIAGO', raw: 'b', categoria: 'Otros' },
      { fecha: '15/01/24', comercio: 'TIENDA C', monto: 3000, ciudad: 'SANTIAGO', raw: 'c', categoria: 'Otros' },
    ]
  ...
  it('sorts DD/MM/YY dates by descending chronology across month boundaries', () => {
    const txs = [
      { fecha: '31/01/24', comercio: 'TIENDA X', monto: 1000, ciudad: 'SANTIAGO', raw: 'a', categoria: 'Otros' },
      { fecha: '01/02/24', comercio: 'TIENDA Y', monto: 2000, ciudad: 'SANTIAGO', raw: 'b', categoria: 'Otros' },
      { fecha: '15/01/24', comercio: 'TIENDA Z', monto: 3000, ciudad: 'SANTIAGO', raw: 'c', categoria: 'Otros' },
    ]
