...
describe('group', () => {
  ...
  it('preserves category totals after removing merchant grouping', () => {
    const txs = [
      { fecha: '01 Mar', comercio: 'JUMBO', monto: 30000, categoria: 'Supermercado' },
      { fecha: '05 Mar', comercio: 'JUMBO', monto: 25000, categoria: 'Supermercado' },
      { fecha: '10 Mar', comercio: 'UNIMARC', monto: 40000, categoria: 'Supermercado' },
    ]
  ...
  it('sorts transactions by date descending within each category', () => {
    const txs = [
      { fecha: '01 Mar', comercio: 'JUMBO', monto: 30000, categoria: 'Supermercado' },
      { fecha: '15 Mar', comercio: 'UNIMARC', monto: 25000, categoria: 'Supermercado' },
      { fecha: '10 Mar', comercio: 'LIDER', monto: 40000, categoria: 'Supermercado' },
    ]
    const result = group(txs)
  ...
  it('sorts DD/MM/YY dates by descending chronology across year boundaries', () => {
    const txs = [
      { fecha: '31/12/23', comercio: 'TIENDA A', monto: 1000, categoria: 'Otros' },
      { fecha: '01/01/24', comercio: 'TIENDA B', monto: 2000, categoria: 'Otros' },
      { fecha: '15/01/24', comercio: 'TIENDA C', monto: 3000, categoria: 'Otros' },
    ]
  ...
  it('sorts DD/MM/YY dates by descending chronology across month boundaries', () => {
    const txs = [
      { fecha: '31/01/24', comercio: 'TIENDA X', monto: 1000, categoria: 'Otros' },
      { fecha: '01/02/24', comercio: 'TIENDA Y', monto: 2000, categoria: 'Otros' },
      { fecha: '15/01/24', comercio: 'TIENDA Z', monto: 3000, categoria: 'Otros' },
    ]
